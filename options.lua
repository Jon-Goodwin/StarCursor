...
if InterfaceOptionsFrame and InterfaceOptionsFrame.OpenToCategory then
    hooksecurefunc("InterfaceOptionsFrame", "OpenToCategory", InterfaceOptionsFrame_OpenToCategory)
